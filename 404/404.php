...
<html lang="en">
  <head>
    ...
    <title>404 | Halaman Tidak Ditemukan | website.com</title>
      ...
      <div class="col-md-12">
        ...
        <div class="ukuran450 tengah margin-b50">
          <div class="login-container">
            <div id="output"></div>
            <div class="form-box">
                <div class="text-center text-danger"><i class="fa fa-5x fa-frown-o"></i></div>
                <h1 class="text-center text-danger">404 - Not Found<p> </p><p><small class="text-center text-danger"> Halaman Tidak Ditemukan</small></p></h1>
                <p class="text-center">Jika halaman ini muncul, kemungkinan anda membuka halaman atau link yang tidak tersedia di website website.com</p>
