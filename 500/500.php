...
<html lang="en">
  <head>
    ...
    <title>500 | Internal Server Error | website.com</title>
      ...
      <div class="col-md-12">
        ...
        <div class="ukuran450 tengah margin-b50">
          <div class="login-container">
            <div id="output"></div>
            <div class="form-box">
                <div class="text-center text-danger"><i class="fa fa-5x fa-wrench"></i></div>
                <h1 class="text-center text-danger">500 - Internal Server Error <p> </p><p><small class="text-center text-danger"> Terjadi Masalah Pada Server-Side</small></p></h1>
                <p class="text-center">Jika halaman ini muncul, kemungkinan terjadi masalah pada server atau program dari sistem. Sistem sedang diperbaikan. Silakan coba lagi setelah ini.</p>
