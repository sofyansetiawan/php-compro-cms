<?php 
session_start();
$title = "Edit Cover Video (4269 x 2231)";
include_once "header.php";
if(isset($_GET['id']) && !empty($_GET['id'])){
  $id = $_GET['id'];
  $seleksi_cover = mysqli_query($koneksi, "SELECT * FROM cover_video WHERE id_cover='$id' LIMIT 1");
?>
          ...
          <nav class="navbar navbar-default navbar-utama nav-admin-data" role="navigation">
            <div class="container-fluid">
              ...
              <div class="navbar-header">
                <a class="navbar-brand" href="#"><i class="fa fa-pencil"></i> Edit Cover Video (4269 x 2231)</a>
              </div>
              ...
              <form class="form-horizontal" role="form" action="action.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                       ...
                       if(!empty($daftar_cover['gambar_cover'])){ 
                            if(file_exists("../upload/image/cover_v/".$daftar_cover['gambar_cover'])){
                          ?>
                            <img src="../upload/image/cover_v/<?php echo $daftar_cover['gambar_cover']; ?>" alt="<?php echo $daftar_cover['gambar_cover']; ?>" class="img-responsive" width="200" onError="this.onerror=null;this.src='../images/no_image/no-cover.png';">
                          <?php
                            }
                            else{
                          ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <div class="form-check">
                        <label>
                          <input type="checkbox" name="dipakai" value="1" <?php if($daftar_cover['used'] == 'ya'){ echo 'checked'; } ?>> <span class="label-text">Dipakai</span>
                        </label>
                      </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary bold" name="cover_video_edit"><i class="fa fa-save"></i> Simpan</button>&nbsp;&nbsp;
